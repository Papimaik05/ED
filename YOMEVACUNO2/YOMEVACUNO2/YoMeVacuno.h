...
class InfoCiudadano {
public:
    InfoCiudadano(const tAnio &anio);
    const tAnio anio() const;
    void setAcept(bool acept) ;
    void setSoli(bool sol);
    const bool aceptado() const;
    const bool solicitud() const;
private:
    tAnio _aniociu;
    bool _aceptado;
    bool _solicitud;
...
class InfoCentro {
public:
    InfoCentro(const tDireccion &direccion, Cola<tIdCiudadano> cola);
    const tDireccion direccion() const;
    Cola<tIdCiudadano> colaCiu();
private:
    tDireccion _direccion;
    Cola<tIdCiudadano> _colaciudadano;
};
...
private:
    Diccionario<tIdCentro, InfoCentro> _centros;
    DiccionarioHash<tIdCiudadano, InfoCiudadano > _ciudadanos;
    tAnio _anio;
    tNumVacunas _vacunas;
    Cola<tIdCiudadano> _colatotal;
