...
class InfoCentro {
public:
    InfoCentro(tDireccion direccion, Cola<tIdCiudadano> cola);
...
private:
    Diccionario<tIdCentro,InfoCentro> centros;
    DiccionarioHash<tIdCiudadano,InfoCiudadano > ciudadanos;
    tAnio _anio;
